...
def interface (trace, arch, mode):
    ...
    for instr, mnemonic, addr, commitvalue in parser.instruction_stream(): # Instrcution_stream yields the given values.
        print(instr, addr, mnemonic, commitvalue)
...
log_file_path = r"C:\Users\Shrreya\OneDrive\Desktop\Courses\InCore_Internship\riscv-isac\riscv_isac\misalign1-jalr-01.log"
