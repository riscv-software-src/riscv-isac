...
# riscv_isac documentation build configuration file, created by
...
htmlhelp_basename = 'RISC-V ISA Coverage'
...
latex_documents = [
    (master_doc, 'riscv_isac.tex', 'RISC-V ISAC Documentation',
...
man_pages = [
    (master_doc, 'riscv_isac', 'RISC-V ISAC Documentation',
